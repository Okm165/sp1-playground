...
use sp1_core_executor::{
    events::{
        Byte3LookupEvent, Byte3Record, ByteLookupEvent, ByteRecord, PrecompileEvent, ShaExtendEvent,
    },
...
impl<F: PrimeField32> MachineAir<F> for ShaExtendChip {
    ...
    fn generate_trace(
        ...
        let mut new_byte3_lookup_events = Vec::new();
